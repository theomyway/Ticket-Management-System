...
{
    public partial class ManageTrainBooking : Form
    {
        public ManageTrainBooking()
        {
            InitializeComponent();
        }
        ...
        string Cat = "Train";
        string Comp1 = "Allama Iqbal Express";
        string Comp2 = "Badin Express";
        ...
        private void ManageTrainBooking_Load(object sender, EventArgs e)
        {
