    ...
    public partial class Bus : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                ...
                double BusOneDayRateInterCity = 0;
                ...
                if (comboBox5.SelectedItem.ToString() == "Daewoo")
                {
                    BusOneDayRateInterCity = 200;
                }
                else if (comboBox5.SelectedItem.ToString() == "Orange Line")
                {
                    BusOneDayRateInterCity = 300;
                }
                
                totalcost = (totaldays * BusOneDayRateInterCity * (Persons * Luggage)) * WaysCommute;
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                MessageBox.Show("You have requested a bus kindly wait for the approval!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
        ...
        private void Bus_Load(object sender, EventArgs e)
        {
            ...
            //Inter City
            comboBox2.Items.Add("Nagan Chorangi");
            comboBox2.Items.Add("Defence");
            comboBox2.Items.Add("Bahadurabad");
            comboBox2.Items.Add("UP More");
            comboBox2.Items.Add("Sakhi Hassan");
            comboBox2.Items.Add("Karimabad");
            //
            ...
            comboBox2.Items.Add("Karimabad");
            //
            comboBox5.Items.Add("Daewoo");
            comboBox5.Items.Add("Orange Line");
